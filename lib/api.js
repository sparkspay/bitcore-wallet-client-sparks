...
var Mnemonic = require('bitcore-mnemonic-sparks');
...
var BASE_URL = 'https://bws.sparkspay.io/bws/api';
...
API.prototype.validateKeyDerivation = function(opts, cb) {
  ...
  function testHardcodedKeys() {
    ...
    xpriv = xpriv.deriveChild("m/44'/5'/0'");
    if (xpriv.toString() != 'xprv9yYtLMwDA1nkeg8xvt4tfScuivNGdjMUDNpc2QfFC34YPMwzoaYAvVjkDvJ1APVeGMJnbJ6gPZMq4G7UfExoP5PpAS3UCF9utjeWa5eXq23') return false;

    var xpub = Bitcore.HDPublicKey.fromString('xpub6CYEjsU6zPM3sADS2ubu2aZeGxCm3C5KabkCpo4rkNbXGAH9M7rRUJ4E5CKiyUddmRzrSCopPzisTBrXkfCD4o577XKM9mzyZtP1Xdbizyk');
